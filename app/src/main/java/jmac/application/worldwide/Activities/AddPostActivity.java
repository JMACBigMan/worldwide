package jmac.application.worldwide.Activities;
...
import jmac.application.worldwide.R;
...
public class AddPostActivity extends AppCompatActivity {
    ...
    private void startPosting() {
        ...
        if (!TextUtils.isEmpty(titleVal) && !TextUtils.isEmpty(descVal)
            ...
            filepath.putFile(mImageUri).continueWithTask(new Continuation() {
                @Override
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddPostActivity.this, "Oops! Something went Wrong", Toast.LENGTH_SHORT).show();
                    mProgress.dismiss();
                }
            });
